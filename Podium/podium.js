...
function main() {
    ...
    function drawChococat() {
        ...
        // Multiplicamos por 1.5 para ele pular alto
        let puloY = Math.abs(Math.sin(time)) * 1.5;

        // Animação das pernas 
        let walkCycle = Math.sin(time * 1.5) * 25;
        ...
        drawCube(0.5, rB, gB, bB, -0.4, -0.70 + puloY, 0, 1.35, 0.5, 0.7);
        ...
        drawCube(0.4, rB, gB, bB, -0.2, -1.20 + puloY, 0, 0.75, 1.3, 1.0);
        theta_x = 0;

...
function main() {
    ...
    function drawChococat() {
        ...
        drawCube(0.2, 1.0, 1.0, 1.0, -0.3, -0.06, 0.5, 1.5, 2, 1);  // branco
        drawCube(0.1, rB, gB, bB, -0.25, -0.15, 0.6, 1, 2, 1);      // pretinho
        //olho - direito (em relacao a minha visao)
        drawCube(0.2, 1.0, 1.0, 1.0, 0.3, -0.06, 0.5, 1.5, 2, 1);   // branco
        drawCube(0.1, rB, gB, bB, 0.25, -0.15, 0.6, 1, 2, 1);       // oretinho
        // fucinho
        ...
        theta_x = 0;
        theta_z = 150; drawCube(0.1, rB, gB, bB, -0.15, -1.25, -0.65, 1.5, 6, 1.0);
        theta_z = 0;
        ...
        theta_z = 150 + leftLimbAngle;
        drawCube(0.5, rB, gB, bB, -0.4, -0.70, 0, 1.35, 0.5, 0.7);

        // Braço Direito
        theta_z = -150 + rightLimbAngle;
        drawCube(0.5, rB, gB, bB, 0.4, -0.70, 0, 1.35, 0.5, 0.7);
        ...
        // Perna Esquerda
        theta_z = 150;
        drawCube(0.4, rB, gB, bB, -0.4, -1.30, 0, 0.75, 1.5, 1.0);
        theta_z = 0;

        // Perna Direita
        theta_z = 150;
        drawCube(0.4, rB, gB, bB, 0.1, -1.30, 0, 0.75, 1.5, 1.0);

        theta_z = 0; // Reset final

...
function main() {
    ...
    function drawCupcake(x_pos, z_pos) {

        gl.clearColor(1.0, 0.71, 0.75, 1.0); // Fundo Rosa bebê
        gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT);
        ...
        const corCobertura = [1.0, 0.4, 0.7];   // Rosa choque
    ...
    requestAnimationFrame(() => drawCupcake(x_pos, z_pos));
    }
    drawCupcake(0.0, 0.0);
}
